...
const JobCard = ({ job }: JobCardProps) => {
  ...
  const { job_tags, category, job_description, name } = job
  ...
  return (
    ...
    <div className="flex-grow p-4 pb-8 max-h-md max-w-md rounded overflow-hidden border-b-8 border-black border-4 border-r-8 shadow-lg bg-white">
